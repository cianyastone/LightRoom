...
void CShape::SetShader(GLuint uiShaderHandle)
{
	...
	m_uiLight2InView = glGetUniformLocation(m_uiProgram, "LightInView2");
	glUniform4fv(m_uiLight2InView, 1, m_vLight2InView);
	...
	//3
	m_uiLight3InView = glGetUniformLocation(m_uiProgram, "LightInView3");
	glUniform4fv(m_uiLight3InView, 1, m_vLight3InView);
	...
	//4
	m_uiLight4InView = glGetUniformLocation(m_uiProgram, "LightInView4");
	glUniform4fv(m_uiLight4InView, 1, m_vLight4InView);
